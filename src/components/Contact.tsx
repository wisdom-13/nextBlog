  ...
  return (
    <div className='flex flex-row shadow-xl rounded-md mt-12' style={{ width: '1200px' }}>
      ...
      <div className='p-6 basis-3/4'>
        ...
        <textarea className='w-full text-sm text-slate-900 placeholder-slate-400 rounded-md p-2 px-3 ring-1 ring-slate-200' rows='10' placeholder='내용을 입력해주세요.'></textarea>
